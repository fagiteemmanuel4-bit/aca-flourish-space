  ...
  return (
    <LegalLayout title="Terms of Use" updated="June 29, 2026">
      <Section title="1. Agreement">
        <p>
          By creating a Lumio account or using the service, you agree to these Terms of Use. If you
          do not agree, do not use Lumio.
        </p>
      </Section>
      <Section title="2. Eligibility">
        <p>
          You must be at least 13 years old (or the minimum digital-consent age in your
          jurisdiction) to use Lumio. If you are under 18, please make sure a parent or guardian
      ...
      <Section title="4. Your content">
        <p>
          You keep ownership of everything you upload to Lumio. You grant us a limited license only
          to store, transmit and display your content to you, as needed to operate the service.
        </p>
        <p>
          You must have the right to upload any content you store on Lumio. Do not upload
      ...
      <Section title="5. Acceptable use">
        <p>
          You agree not to: (a) abuse, disrupt or attempt to gain unauthorized access to Lumio; (b)
          upload malicious files; (c) violate any law or the rights of others; or (d) use Lumio to
          facilitate academic dishonesty as defined by your school.
        </p>
      </Section>
      <Section title="6. Service availability">
        <p>
          Lumio is provided on an "as is" and "as available" basis. We do not guarantee
      ...
      <Section title="8. Limitation of liability">
        <p>
          To the maximum extent permitted by law, Lumio and its operators are not liable for any
      ...
      <Section title="9. Changes">
        <p>
          We may update these terms from time to time. Continued use of Lumio after changes take
      ...
      <Section title="10. Contact">
        <p>
          ...
          <a className="text-primary hover:underline" href="mailto:hello@lumio.io">
            hello@lumio.io
          </a>
          .
        </p>
